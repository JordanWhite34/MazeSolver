...
public class DijkstraShortestPathFinderTests extends BaseGraphTests {
    ...
    void myTest2() {
        SPTShortestPathFinder<Graph<String, Edge<String>>, String, Edge<String>> pathFinder
            = createShortestPathFinder();
        Map<String, Edge<String>> spt1 = pathFinder.constructShortestPathsTree(graph(
                edge("s", "a", 1),
                edge("s", "b", 2),
                edge("a", "t", 3),
                edge("b", "t", 1)),
        ...
        ShortestPath<String, Edge<String>> path1 = pathFinder.extractShortestPath(spt1, "s", "t");
        double weight1 = path1.totalWeight();

        Map<String, Edge<String>> spt2 = pathFinder.constructShortestPathsTree(graph(
                edge("s", "a", 1),
                edge("s", "b", 2),
                edge("a", "t", 1),
                edge("b", "t", 1)),
        ...
        ShortestPath<String, Edge<String>> path2 = pathFinder.extractShortestPath(spt1, "s", "t");
        double weight2 = path1.totalWeight();
    ...
    void myTest3() {
        SPTShortestPathFinder<Graph<String, Edge<String>>, String, Edge<String>> pathFinder
            = createShortestPathFinder();
        Map<String, Edge<String>> spt = pathFinder.constructShortestPathsTree(directedGraph(
                edge("a", "b", 2),
                edge("a", "c", 1),
                edge("a", "d", 4),
                ...
                edge("h", "g", 1)), "a", "e");
        ShortestPath<String, Edge<String>> path = pathFinder.extractShortestPath(spt, "a", "e");
    ...
    void myTest1() {
        SPTShortestPathFinder<Graph<String, Edge<String>>, String, Edge<String>> pathFinder
            = createShortestPathFinder();
        Map<String, Edge<String>> spt = pathFinder.constructShortestPathsTree(graph(
                edge("s", "a", 1),
                edge("s", "b", 2),
                edge("a", "t", 1), // same graph shape, but this edge weight changed
                edge("b", "t", 1)),
        ...
        ShortestPath<String, Edge<String>> extracted = pathFinder.extractShortestPath(spt, "s", "t");

        assertThatShortestPathOf(graph(
            edge("s", "a", 1),
            edge("s", "b", 2),
            edge("a", "t", 1), // same graph shape, but this edge weight changed
            edge("b", "t", 1)), spt, "s", "t").pathIsValid();
    }
