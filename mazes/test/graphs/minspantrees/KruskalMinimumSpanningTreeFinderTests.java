...
public class KruskalMinimumSpanningTreeFinderTests extends BaseGraphTests {
    ...
    void myTest_2() {
        ...
        KruskalMinimumSpanningTreeFinder<KruskalGraph<String, Edge<String>>, String, Edge<String>> mstFinder =
            new KruskalMinimumSpanningTreeFinder<>();
        MinimumSpanningTree<String, Edge<String>> mst = mstFinder.findMinimumSpanningTree(graph);
        assertThatMSTOf(graph).hasEdges(graph.allEdges());
